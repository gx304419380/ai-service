 ...
 */
public class YoloV8RelativeTranslator extends ObjectDetectionTranslator {

    private final YoloOutputType yoloOutputLayerType;
     ...
     */
    protected YoloV8RelativeTranslator(Builder builder) {
        super(builder);
    ...
    /**
     * Creates a builder to build a {@link YoloV8RelativeTranslator}.
     *
     * @return a new builder
     */
    public static YoloV8RelativeTranslator.Builder builder() {
        return new YoloV8RelativeTranslator.Builder();
    }
     ...
     * @return a new builder
     */
    public static YoloV8RelativeTranslator.Builder builder(Map<String, ?> arguments) {
        YoloV8RelativeTranslator.Builder builder = new YoloV8RelativeTranslator.Builder();
    ...
    /** The builder for {@link YoloV8RelativeTranslator}. */
    public static class Builder extends ObjectDetectionBuilder<YoloV8RelativeTranslator.Builder> {
         ...
         */
        public YoloV8RelativeTranslator build() {
            ...
            validate();
            return new YoloV8RelativeTranslator(this);
        }
    }
