...
public class FaceDetectionTranslator implements Translator<Image, DetectedObjects> {
    ...
    public DetectedObjects processOutput(TranslatorContext ctx, NDList list) {
        ...
        NDArray boxRecover = boxRecover(ctx.getNDManager(), width, height, scales, steps);
    ...
    private NDArray boxRecover(
        ...
        try(NDArray ndArray = manager.create(boxes)) {
            return ndArray.clip(0.0, 1.0);
        }
    }
